...
namespace Framework
{
    public class JWTAuthenticate
    {
        ...
        public JWTAuthenticate(JwtTokenConfig jwtTokenConfig)
        {
        ...
        public LoginReponse GenerateTokens(string username, Claim[] claims, DateTime now)
        {
        ...
        public LoginReponse Refresh(string refreshToken, string accessToken, DateTime now)
        {
